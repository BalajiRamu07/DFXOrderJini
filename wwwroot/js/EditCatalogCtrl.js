...
angular.module('ebs.controller')
    ...
    .controller("EditCatalogCtrl",function ($scope, $filter, $http, $modal,$routeParams, $window, toastr,Settings) {
...
//                        });
        ...
        console.log("instanceDetails.country", instanceDetails);
        ...
        //
        //                 $http.post("/dash/newitems", $scope.newItem)
        //                     .success(function (res) {
        //                         //console.log(res)
        //
        //                         if (!res.imageStatus) {
    ...
    //    $scope.itemsColname(Settings.getItemData())
